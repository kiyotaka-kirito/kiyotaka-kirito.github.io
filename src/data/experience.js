...
export const timeline = [
  ...
  },
  {
    id: 2,
    type: 'certificate',
    role: 'SwiftUI & UIKit Certification',
    company: 'Hacking with Swift',
    location: 'Online',
    startDate: '2023',
    endDate: '2024',
    description: [
      'Completed in-depth SwiftUI and UIKit certification courses.',
  ...
  },
  {
    id: 3,
    type: 'certificate',
    role: 'PADC Certified Developer',
    company: 'Professional App Developer Certificate (PADC)',
    location: 'Myanmar',
    startDate: '2022',
    endDate: '2023',
    description: [
      'Completed the PADC program — a rigorous industry-recognized certification for mobile developers in Myanmar.',
      'Covered Swift fundamentals, design patterns, API integration, and app deployment.',
    ],
    current: false,
  },
  {
